...
$('#fpm').val(data);
   ...
   <?php
        if(isset($_POST['submit'])){
            ...
            $query = "INSERT INTO `room_request` (`id`,`regno`,`firstname` ,`Building_Name`,`floor_no`, `room_no`,`bed_no`,`bed_location`, `bed_rent`,`contact`, `message`,`msg`, `date`) VALUES (NULL,'$regno' ,'$firstname','$Building_Name','$floor_no', '$room_no','$bed_no','$bed_location','$bed_rent','$contact', '$message','$msg', CURRENT_TIMESTAMP)";
...
<?php $query ="SELECT * FROM f_room_add";
