   ...
   <link rel="stylesheet" type="text/css" href="signup.css">
    ...
    <?php
        if(isset($_POST['signup'])){
            ...
            $query = "INSERT INTO `frequests` (`id`,`regno` ,`firstname`, `lastname`,`contact`,`gender`, `email`,`dept`,`religion`,`address`,`password`, `message`, `date`) VALUES (NULL,'$regno' ,'$firstname', '$lastname', '$contact','$gender','$email', '$dept','$religion','$address','$password', '$message', CURRENT_TIMESTAMP)";
  ...
  <body class="text-center" style="background-color: #cfebfd;">
      <div class="container">
            <form method="post" class="form-signin">
              ...
              <input name="regno" type="text" id="inputEmail" class="form-control" placeholder="Faculty id" required autofocus>
