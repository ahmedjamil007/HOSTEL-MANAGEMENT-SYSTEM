...
if(isset($_POST['done'])){
 ...
 $q = " INSERT INTO `room_add`( `Building_Name`,`floor_no`,`room_no`,`bed_no`,`bed_location`,`bed_rent`) VALUES (  '$Building_Name','$floor_no','$room_no','$bed_no','$bed_location','$bed_rent' )";
...
<?php  ?>
  ...
  <tr>
   ...
   <td> <center><button class="btn-danger btn" style="background-color:inherit;"> <a style="text-decoration: none;color: white;"href="r_delete.php?id=<?php echo $row['id']; ?>" class="text-white"> Delete </a>  </button></center></td>
  </tr>
   <?php } ?>
