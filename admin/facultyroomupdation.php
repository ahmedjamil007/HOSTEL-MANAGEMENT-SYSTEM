         ...
         <td><?php echo $row['bed_no']; ?></td>
          <td><?php echo $row['bed_location']; ?></td>
           <td><?php echo $row['bed_rent']; ?></td>
            <td><center><button class="btn-danger btn" style="background-color:inherit;"> <a style="text-decoration: none;color: white;"href="fr_delete.php?id=<?php echo $row['id']; ?>" class="text-white"> Delete </a>  </button></td>
