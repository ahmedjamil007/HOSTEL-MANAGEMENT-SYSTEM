...
<?php  ?>
  ...
  <tr>
   ...
   <td> <center><button class="btn-danger btn" style="background-color:inherit;"> <a style="text-decoration: none;color: white;"href="fs_delete.php?id=<?php echo $row['id']; ?>" class="text-white"> Delete </a>  </button></center></td>
  </tr>
   <?php } ?>
