      ...
      ?>
            <td width="10%"><input type="text" name="regno" value="<?php echo $row->regno;?>" class="guest_input"readonly ><?php } ?>
                     ...
                     <td width="15%">
                      ...
                      <td width="10%">
                         <button id="bot" class="button"  type="submit" name="meal_sub">Submit</button>
                      </td>
...
<script>
for (var i = 0; i <3; i++) {
        document.querySelectorAll(".bot")[i].addEventListener("click",function(){
             var text= this.innerHTML;
             console.log(text);
             switch(text){
                case "Submi":
                var audio = new Audio("announcement-sound-4-21464.mp3");
                audio.play();
                break;
                 case"Submi":
                var audio = new Audio("announcement-sound-4-21464.mp3");
